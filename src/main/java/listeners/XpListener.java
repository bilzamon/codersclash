...
/**
 * The listener interface for receiving xp events.
 * The class that is interested in processing a xp
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addXpListener<code> method. When
 * the xp event occurs, that object's appropriate
 * method is invoked.
 *
 * @see XpEvent
 */
